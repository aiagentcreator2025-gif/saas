            ...
            <div key={step.id} style={{ display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    {step.live ? (
                      <div style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 9, fontWeight: 700, color: "#10B981", background: "rgba(16,185,129,0.1)", padding: "3px 9px", borderRadius: 20 }}>
                        <span style={{ width: 5, height: 5, borderRadius: "50%", background: "#10B981", display: "inline-block", animation: "blink 1.4s ease infinite" }} />
                        Live
                      </div>
                    ) : (
              ...
              {i < steps.length - 1 && (
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", margin: "4px 0" }}>
                  ...
                  <div style={{ width: 22, height: 22, borderRadius: "50%", border: "2px solid #E5E7EB", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#9CA3AF", boxShadow: "0 1px 4px rgba(0,0,0,0.08)" }}>
                    <Plus size={12} />
                  </div>
      ...
      <div style={{ width: 300, background: "#fff", borderLeft: "1px solid #E5E7EB", padding: "24px 20px", overflowY: "auto" }}>
        {selectedStep ? (
          <>
            ...
            <button style={{ width: "100%", padding: "11px", borderRadius: 9, border: "none", background: "linear-gradient(135deg,#6366F1,#8B5CF6)", color: "#fff", fontSize: 12, fontWeight: 600, cursor: "pointer", boxShadow: "0 4px 14px rgba(99,102,241,0.3)" }}>Save Changes</button>
          </>
        ) : (
