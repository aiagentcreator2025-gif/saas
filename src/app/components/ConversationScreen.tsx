...
const CLIENT_ID = "1fc97cde-dfd6-47ec-b3cb-932abb919142"; // your client row id
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
              ...
              {messages.map(msg => {
                ...
                return (
                  <div key={msg.id} style={{ display: "flex", justifyContent: isOutbound ? "flex-end" : "flex-start" }}>
                    <div style={{
                      maxWidth: "65%", padding: "9px 14px", borderRadius: isOutbound ? "14px 14px 4px 14px" : "14px 14px 14px 4px",
                      background: isOutbound ? "#1A1916" : "#FFFFFF",
                      border: isOutbound ? "none" : "1px solid #E8E6E0",
                      fontSize: 13, color: isOutbound ? "#fff" : "#1A1916", fontWeight: 300, lineHeight: 1.5,
                    }}>
                      {msg.content}
            ...
            <div style={{ padding: "14px 24px", borderTop: "1px solid #E8E6E0", background: "#FFFFFF", display: "flex", gap: 10, alignItems: "flex-end" }}>
              <textarea
                ...
                rows={1}
                style={{ flex: 1, padding: "10px 14px", border: "1px solid #E8E6E0", borderRadius: 10, fontSize: 13, color: "#1A1916", background: "#F9F9F8", outline: "none", fontFamily: "'DM Sans', sans-serif", fontWeight: 300, resize: "none", lineHeight: 1.5 }}
              />
              <button
                className="send-btn"
                style={{ width: 38, height: 38, borderRadius: 10, border: "none", background: "#1A1916", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", flexShrink: 0, transition: "opacity .15s" }}
              >
