...
<div style={{
  ...
  {/* Orbs — give the glass something to refract */}
  ...
  <div style={{
    ...
    <nav style={{ flex: 1, padding: "14px 10px", overflowY: "auto", position: "relative", zIndex: 1 }}>
      <div style={{ fontSize: 9, letterSpacing: "1.5px", textTransform: "uppercase", color: "rgba(100,80,180,0.5)", padding: "0 10px", marginBottom: 8, fontWeight: 500 }}>
        Menu
      </div>
    ...
    <div style={{ padding: "10px 10px 14px", borderTop: "1px solid rgba(255,255,255,0.25)", position: "relative", zIndex: 1 }}>
      ...
      <div style={{
        ...
        <div style={{ width: 30, height: 30, borderRadius: "50%", background: "rgba(255,255,255,0.4)", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.7)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 600, color: "#4A46B5", flexShrink: 0 }}>
          {initials}
        </div>
