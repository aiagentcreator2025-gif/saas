...
export function Sidebar({ active, onNav }: Props) {
  ...
  return (
    <>
      ...
      {/* Outer wrapper — full height, background color shows behind the floating card */}
      <div style={{
        width: 240,
        flexShrink: 0,
        height: "100vh",
        ...
        <div style={{
          ...
          {/* Logo */}
          <div style={{ padding: "20px 18px 16px", borderBottom: "1px solid #E8E6E0" }}>
            <img
          ...
          {/* Bottom */}
          <div style={{ padding: "10px 10px 14px", borderTop: "1px solid #E8E6E0" }}>
            ...
            <div style={{ marginTop: 10, padding: "10px", background: "#F7F6F3", borderRadius: 12, display: "flex", alignItems: "center", gap: 9, border: "1px solid #E8E6E0" }}>
