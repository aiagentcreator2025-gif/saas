...
export function CoFounderScreen() {
  ...
  // Persist session per browser so chats survive page refresh
  ...
  return (
    <div style={{
      ...
      overflow:"hidden", padding:"12px 12px 12px 0",
    }}>
      <style>{`
        @keyframes dotPulse {
        ...
        .msg-in{animation:agentIn 0.22s ease both}
      `}</style>

      </* ── Glass card ──────────────────────────────────────────── */>
      <div style={{
        flex:1, display:"flex", flexDirection:"column", borderRadius:24,
        overflow:"hidden",
        ...
        boxShadow:"inset 0 1.5px 0 rgba(255,255,255,0.85),0 4px 24px rgba(0,0,0,0.05)",
      }}>
        ...
        <div style={{
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div>
                <div style={{fontSize:15,fontWeight:600,color:"#1A1916",lineHeight:1.2,transition:"all 0.35s"}}>
                  {meta.label}
                </div>
                <div style={{fontSize:11,color:"rgba(60,40,120,0.5)",fontWeight:400}}>
                  {meta.role}
                </div>
              </div>
            </div>
                ...
                <div key={step} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:5}}>
                  <div style={{
                    ...
                    background: done||active
                      ? "linear-gradient(90deg,rgba(99,102,241,0.85),rgba(99,102,241,0.4))"
                      : "rgba(255,255,255,0.4)",
                    transition:"all 0.4s ease",
                  }} />
                  <div style={{
                    fontSize:9,fontWeight:active?600:(done?500:400),textAlign:"center",
                    color:active?"#3730a3":(done?"rgba(99,102,241,0.7)":"rgba(60,40,120,0.3)"),
                    transition:"all 0.3s",
                  }}>
                    {done?"✓ ":""}{step}
                  </div>
            ...
            <div key={i} className="msg-in">
              {msg.isHandoff && msg.role==="assistant" && (
                <div style={{display:"flex",alignItems:"center",gap:10,margin:"4px 0 14px"}}>
                  ...
                  <div style={{
                    fontSize:10,fontWeight:600,color:"rgba(99,102,241,0.6)",
              ...
              {msg.role==="assistant" ? (
                <div style={{display:"flex",gap:9,alignItems:"flex-start"}}>
                  <div style={{
                    ...
                    background:AGENT_META[msg.agentName||"alex"]?.bg||"rgba(99,102,241,0.1)",
                    border:`1px solid ${AGENT_META[msg.agentName||"alex"]?.color||"#6366f1"}25`,
                    display:"flex",alignItems:"center",justifyContent:"center",
                    fontSize:11,fontWeight:700,
                    color:AGENT_META[msg.agentName||"alex"]?.color||"#4A46B5",
                  }}>{AGENT_META[msg.agentName||"alex"]?.initial||"L"}</div>
                  <div style={{maxWidth:"74%",display:"flex",flexDirection:"column",gap:3}}>
                    ...
                    <div style={{
                      ...
                      fontSize:13,lineHeight:1.65,color:"#1A1916",
                ...
                <div style={{display:"flex",justifyContent:"flex-end"}}>
                  <div style={{
                    maxWidth:"68%",
                    background:"linear-gradient(135deg,rgba(99,102,241,0.82),rgba(67,56,202,0.88))",
                    backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",
                    border:"1px solid rgba(99,102,241,0.3)",
                    borderRadius:"14px 4px 14px 14px",padding:"11px 14px",
                    fontSize:13,lineHeight:1.65,color:"#fff",
                    boxShadow:"0 2px 12px rgba(99,102,241,0.22)",whiteSpace:"pre-wrap",
                  }}>{msg.content}</div>
                </div>
              )}
            </div>
        ...
        <div style={{padding:"14px 20px 18px",borderTop:"1px solid rgba(255,255,255,0.3)"}}>
          ...
          <div style={{textAlign:"center",marginTop:7,fontSize:10,color:"rgba(60,40,120,0.3)"}}>
